...
def get_optimizer():
    ...
    optimizer =tf.train.GradientDescentOptimizer(learning_rate=lr)# tf.train.AdamOptimizer(learning_rate=lr, beta1=0.9, beta2=0.999, epsilon=1e-08) 
    return optimizer
...
def save_model_as(train_history, validation_history):
    ...
    if validation_history[n_epoch - 1][0] > max_val_acc:
        ...
        savemodel = "mobilenet_retrain_do0.3"
